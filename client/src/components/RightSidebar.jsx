...
const RightSidebar = () => {
    ...
    return selectedUser && (
        <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll max-h-full p-6 ${selectedUser ? "max-md:hidden" : ""}`}>
            <div className='flex flex-col items-center gap-3'>
                ...
                <p className='text-center text-sm text-gray-200 px-4'>{selectedUser.bio}</p>
            </div>
